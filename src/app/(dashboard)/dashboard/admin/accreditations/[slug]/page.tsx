...
import { AdminAccreditationRetrieve, DemandStatus } from "@/types/api";
        ...
        <TabsContent value="degrees" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Liste des diplômes associés à cette accréditation
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="experiences" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Liste des expériences associées à cette accréditation
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="trainings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Liste des formations associées à cette accréditation
              </CardDescription>
            </CardHeader>
            <CardContent>
